...
def store_json():
    """
    This function converts the json to database
    """
    with database.transaction():  # to moderately increase the speed
            ...
            for f in files:
                ...
                with codecs.open(file_path, "r", encoding="utf-8") as f:
                    ...
                    for item in content:
                        ...
                        # parsing Speculator
                        is_guest = bool(int(item["q_isguest"]))
                        name = item["q_name"]
                        try:
                        ...
                        is_canceled = bool(int(item["hasCancel"]))
                        ...
                        if "reply" in item:
                            for reply in item["reply"]:
                                ...
                                content = reply["r_content"].strip
                                is_check = bool(int(reply["isCheck"]))
